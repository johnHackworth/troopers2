...
const culturesArray = [ 'spanish', 'anglosaxon', 'arabic', 'eastAsian', 'generic' ];

export function getRandomName( culture, sex ) {
...
export function getRandomCulture() {
	const pos = Math.floor( Math.random() * culturesArray.length );
